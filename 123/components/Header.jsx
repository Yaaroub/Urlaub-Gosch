...
export default function Header() {
  ...
  return (
    <>
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              ...
              className={[
                ...
                solid
                  ? "bg-[#071827] text-white hover:bg-[#0f6f8f]"
                  : "bg-[#eecb83] text-[#071827] hover:bg-white",
              ].join(" ")}
            >
      ...
      {/* Mobile / Tablet Menu */}
      {open && (
        <div className="fixed inset-0 z-40 bg-[#071827]/96 px-4 pb-6 pt-24 text-white backdrop-blur-xl lg:hidden">
          <div className="mx-auto flex h-full max-w-md flex-col">
            ...
            <div className="mt-auto rounded-[2rem] border border-white/12 bg-white/[0.08] p-4 shadow-2xl shadow-black/20">
              ...
              <Link
                href="/offers"
                onClick={() => setOpen(false)}
                className="mt-4 inline-flex w-full items-center justify-center gap-2 rounded-full bg-[#eecb83] px-5 py-3.5 text-sm font-bold text-[#071827] transition hover:bg-white"
              >
                Unterkunft suchen
                <Search className="h-4 w-4" />
              </Link>
